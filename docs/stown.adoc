...
https://www.seichter.de/stown/stown.pdf[PDF] format. Source code is
https://github.com/rseichter/stown[available here].
...
allow other users to participate. Lastly, there is the dedicated email address
_stown at seichter.de_. Note that this address is not backed by a ticket system
or mailing list, just little old me. My support offer is strictly voluntary, so
